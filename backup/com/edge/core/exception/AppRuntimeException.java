...
public class AppRuntimeException extends RuntimeException {
    ...
    public AppRuntimeException(Exception ex, String message) {
        super(message);
        this.exception = ex;
        customMessage = message;
    }

    public AppRuntimeException(Exception ex, String message, String customFooter, List<String> errorMessages) {
        super(message);
        this.exception = ex;
